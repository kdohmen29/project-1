...
$("#submit").on("click", function (e) {
    ...
    function googlePlacesSearch(lat, lon) {
        ...
        var queryURL = proxyUrl + "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + lat + "," + lon + "&radius=20000&limit=5&type=restaurant&keyword=pizza&key=AIzaSyB3mWQO5pN0C9zmp5kRAD3H10NYKVv3ohA"
